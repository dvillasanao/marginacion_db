#' Base de índice de marginación a nivel estatal, 2015
#'
#' Base de datos del índice de marginación a nivel estatal, 2015. Esta base contiene a la población total, indicadores
...
#' @name IME_2015
#' @usage IME_2015
#' @format A data frame with 32 observations on the following 16 variables.
#' @examples
#' \dontrun{head(IME_2015)}
"IME_2015"
