#' Base de índice de marginación a nivel municipal, 2010
#'
#' Base de datos del índice de marginación a nivel municipal, 2010. Esta base contiene a la población total, indicadores
...
#' @name IMM_2010
#' @usage IMM_2010
#' @format A data frame with 2456 observations on the following 18 variables.
#' @examples
#' \dontrun{head(IMM_2010)}
"IMM_2010"
