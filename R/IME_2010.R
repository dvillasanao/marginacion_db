#' Base de índice de marginación a nivel estatal, 2010
#'
#' Base de datos del índice de marginación a nivel estatal, 2010. Esta base contiene a la población total, indicadores
