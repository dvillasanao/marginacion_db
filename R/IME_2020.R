#' Base de índice de marginación a nivel estatal, 2020
#'
#' Base de datos del índice de marginación a nivel estatal, 2020. Esta base contiene a la población total, indicadores
