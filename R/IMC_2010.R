#' Base de índice de marginación a nivel colonia, 2020
#'
#' Base de datos del índice de marginación a nivel colonia urbana, 2020. Esta base contiene a la población total, indicadores
...
#'
#' \itemize{
#' \item{\code{CVE_COL}}{- Clave de colonia}
#' \item{\code{ID_COL}}{- ID de la colonia}
#' \item{\code{ID_INE_2020}}{- ID de la colonia (INE)}
#' \item{\code{NOM_COLONIA}}{- Nombre de la colonia}
#' \item{\code{CP}}{- Código Postal}
#' \item{\code{CLASIF}}{- Clasificación de colonias}
...
#' @name IMUC_2020
#' @usage IMUC_2020
#' @format A data frame with 74226 observations on the following 29 variables.
#' @examples
#' \dontrun{head(IMUC_2020)}
"IMUC_2020"
